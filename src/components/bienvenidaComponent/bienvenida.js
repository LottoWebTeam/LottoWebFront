            ...
            <div className="flex-container">
                <div className="row">
                    <div className="col-sm-4" >
                        <center>
                            <img alt="logo" src="/img/fondo.PNG" className="img img-responsive col-lg-12" />
                            <img alt="logo" src="/img/fondo.PNG" className="img img-responsive col-lg-12" />
                            <img alt="logo" src="/img/fondo.PNG" className="img img-responsive col-lg-12" />
                            <img alt="logo" src="/img/fondo.PNG" className="img img-responsive col-lg-12" />
                            <img alt="logo" src="/img/fondo.PNG" className="img img-responsive col-lg-12" />
                    ...
                    <div className="col-sm-8">
                        ...
                        <div class="row">
                           <div class="col-sm-6">
                             <h5 align="center">Se uno de nuestros transportadores y encuentra viajes fácilmente. Tú estableces la tarifa</h5>
                             <p></p>
                             <h3 align="center">Registrate para hacer parte de esta familia</h3>
                             <p></p>
                             <button className="btn btn-outline btn-light col-lg-12">Registrarse</button>
                           </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-sm-6">
                           <button className="btn btn-outline btn-light col-lg-12">Iniciar viaje</button>
                           </div>
                        </div>
                    </div>
                </div>
